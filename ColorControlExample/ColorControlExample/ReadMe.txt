================================================================================
    MFC (MICROSOFT FOUNDATION CLASS) ライブラリ : ColorControlExample プロジェクトの概要
===============================================================================

この ColorControlExample アプリケーションは、アプリケーション ウィザードによって作成されました。このアプリケーションは MFC の基本的な使い方を示すだけでなく、アプリケーションを作成するための開始点でもあります。

このファイルには、ColorControlExample アプリケーションを構成する各ファイルの内容の概要が含まれています。

ColorControlExample.vcxproj
...
ColorControlExample.vcxproj.filters
...
ColorControlExample.h
    これはアプリケーションのメイン ヘッダー ファイルです。
    その他のプロジェクト固有のヘッダー (Resource.h など) が含まれ、CColorControlExampleApp アプリケーション クラスを宣言します。

ColorControlExample.cpp
    これはメインのアプリケーション ソース ファイルで、CColorControlExampleApp アプリケーション クラスが含まれています。

ColorControlExample.rc
...
res\ColorControlExample.ico
    これはアプリケーションのアイコンとして使用されるアイコン ファイルです。このアイコンは、メイン リソース ファイル ColorControlExample.rc にインクルードされます。

res\ColorControlExample.rc2
...
ColorControlExampleDlg.h, ColorControlExampleDlg.cpp - ダイアログ
    これらのファイルには、CColorControlExampleDlg クラスが含まれます。このクラスはアプリケーションのメイン ダイアログの動作を定義します。ダイアログのテンプレートは、Microsoft Visual C++ で編集できる ColorControlExample.rc に含まれています。
...
StdAfx.h, StdAfx.cpp
    これらのファイルは、ColorControlExample.pch という名前のプリコンパイル済みヘッダー (PCH) ファイルと、StdAfx.obj という名前のプリコンパイル済みの型ファイルをビルドするために使用されます。

Resource.h
    これは、新しいリソース ID を定義する標準のヘッダー ファイルです。このファイルの読み込みおよび更新は、Microsoft Visual C++ で行います。

ColorControlExample.manifest
