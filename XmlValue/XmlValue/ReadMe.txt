========================================================================
    Win32 アプリケーション: XmlValue プロジェクトの概要
========================================================================

この XmlValue アプリケーションは、AppWizard により作成されました。
...
XmlValue.ico
    ...
    ファイルです。
    このアイコンは、メイン リソース ファイル XmlValue.rc 
    にインクルードされます。

small.ico
    これは、アプリケーションのアイコンの小さいバージョン (16x16) を含むアイコン 
    ファイルです。 このアイコンは、メイン リソース ファイル XmlValue.rc 
    にインクルードされます。
