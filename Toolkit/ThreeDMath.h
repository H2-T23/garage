...
namespace ThreeDMath {
	...
	public:
		...
		static CVector3		Cross( const CVector3& v1, const double dScaler ){
			return CVector3(	v1.x * dScaler
							,	v1.y * dScaler
							,	v1.z * dScaler	);
		}

		static CVector3		Cross( const double dScaler, const CVector3& v1 ){
	...
	CVector3	operator*( const CVector3& v1, const double dScaler ){
		return CVector3::Cross(v1, dScaler);
	}

	CVector3	operator*( const double dScaler, const CVector3& v1 ){
		return CVector3::Cross(v1, dScaler);
	}
	...
	public:
		...
		CQuaternion( double s, double x, double y, double z ) : S(1.0), V(0.0,0.0,0.0) {
			Set(s,x,y,z);
		}
