...
protected:
	...
	virtual LPCTSTR			Filter( void ) const	{ return _T("All files(*.*)\0*.*\0\0");	}
	virtual LPCTSTR			DefExt( void ) const	{ return _T(""); }
 ...
 *
 */
class CTextOpenDlg : public CFileOpenDlg {
protected:
...
protected:
	...
	virtual LPCTSTR			Filter( void ) const	{ return _T("All files(*.*)\0*.*\0\0");	}
	virtual LPCTSTR			DefExt( void ) const	{ return _T(""); }
	virtual	DWORD			Flags( void ) const		{ return(OFN_OVERWRITEPROMPT);	}
