...
// MFCOLEDragAndDrop.cpp : アプリケーションのクラス動作を定義します。
//
...
// CMFCOLEDragAndDropApp コンストラクション
...
// 唯一の CMFCOLEDragAndDropApp オブジェクトです。

CMFCOLEDragAndDropApp theApp;


// CMFCOLEDragAndDropApp 初期化
...
// CMFCOLEDragAndDropApp メッセージ ハンドラー
...
// CMFCOLEDragAndDropApp のカスタマイズされた読み込みメソッドと保存メソッド
