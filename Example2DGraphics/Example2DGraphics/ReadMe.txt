========================================================================
    Win32 アプリケーション: Example2DGraphics プロジェクトの概要
========================================================================

この Example2DGraphics アプリケーションは、AppWizard により作成されました。

このファイルには、Example2DGraphics 
アプリケーションを構成する各ファイルの内容の概要が含まれています。


Example2DGraphics.vcxproj
...
Example2DGraphics.vcxproj.filters
...
Example2DGraphics.ico
    これは、アプリケーションのアイコン (32x32) として使用されるアイコン 
    ファイルです。
    このアイコンは、メイン リソース ファイル Example2DGraphics.rc 
    にインクルードされます。

small.ico
    これは、アプリケーションのアイコンの小さいバージョン (16x16) を含むアイコン 
    ファイルです。 このアイコンは、メイン リソース ファイル Example2DGraphics.rc 
    にインクルードされます。
...
StdAfx.h、StdAfx.cpp
    これらのファイルは、Example2DGraphics.pch 
