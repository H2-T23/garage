========================================================================
    Win32 アプリケーション: TableData プロジェクトの概要
========================================================================

この TableData アプリケーションは、AppWizard により作成されました。
...
TableData.ico
    ...
    ファイルです。
    このアイコンは、メイン リソース ファイル TableData.rc 
    にインクルードされます。

small.ico
    これは、アプリケーションのアイコンの小さいバージョン (16x16) を含むアイコン 
    ファイルです。 このアイコンは、メイン リソース ファイル TableData.rc 
    にインクルードされます。
