========================================================================
    コンソール アプリケーション : ThreadLog プロジェクトの概要
========================================================================

AppWizard はユーザー用に ThreadLog アプリケーションを作成しました。  
このファイルには ThreadLog アプリケーションを構成している
各ファイルの概要が含まれています。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済みヘッダー (PCH) ファイル ThreadLog.pch、
