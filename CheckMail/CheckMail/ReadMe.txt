========================================================================
    Win32 アプリケーション: CheckMail プロジェクトの概要
========================================================================

この CheckMail アプリケーションは、AppWizard により作成されました。
...
CheckMail.ico
    ...
    ファイルです。
    このアイコンは、メイン リソース ファイル CheckMail.rc 
    にインクルードされます。

small.ico
    これは、アプリケーションのアイコンの小さいバージョン (16x16) を含むアイコン 
    ファイルです。 このアイコンは、メイン リソース ファイル CheckMail.rc 
    にインクルードされます。
